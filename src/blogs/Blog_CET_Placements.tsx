import img1 from "../assets/CET_Blog/1_minecraft.webp";
import img2 from "../assets/CET_Blog/2_gru.webp";
import img3 from "../assets/CET_Blog/3_CGPU_regular.webp";
import img4 from "../assets/CET_Blog/4_CGPU_core.webp";
import img5 from "../assets/CET_Blog/5_sample_sheet.webp";
import img6 from "../assets/CET_Blog/6_interview_wojaks.webp";
import img7 from "../assets/CET_Blog/7_lightning_mcqueen_aptitude.webp";
import img8 from "../assets/CET_Blog/8_coding_questions_car_drift.webp";
import img9 from "../assets/CET_Blog/9_rick_rolling.webp";
import img10 from "../assets/CET_Blog/10_hackerrank_evergiven.webp";
import img11 from "../assets/CET_Blog/11_breaking_bad_danger.webp";
import img12 from "../assets/CET_Blog/12_tyrion_advice.webp";
import img13 from "../assets/CET_Blog/13_hr_questions.webp";
import img14 from "../assets/CET_Blog/14_samwell_got_ending.webp";

export const Blog_CET_Placements: React.FC = () => (
  <article>
    <h3 className="text-2xl font-bold mb-4">You got into CET, how do you get out?</h3>
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img1} alt="Accurate representation of the situation if this were Minecraft" />
      <figcaption className="text-sm text-gray-500">Accurate representation of the situation if this were Minecraft</figcaption>
    </figure>
    <p className="mb-4">
    ...
    <p className="mb-4">
      Alright. I'm guessing you came to read this for actual advice, and you see me blabbering like one of those recipe blogs that go over their entire life stories, so I'm taking the more responsible route of cutting to the chase <em>cue road runner music</em>.
    </p>
    <p className="mb-4">
      <strong>How are placements gonna be?</strong> Short answer - messy, and honestly a bit tough on you. Long answer - Well, it depends, and that's why it's the long answer. In fact, I encourage you to read this, especially if the short answer didn't appeal to you.
    </p>
    <h3 className="text-xl font-semibold mt-8 mb-2">The Process</h3>
    <hr className="mb-4" />
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img2} alt="You're lying if you say you haven't heard this" />
      <figcaption className="text-sm text-gray-500">You're lying if you say you haven't heard this</figcaption>
    </figure>
    <p className="mb-4">
      More often than not, that number is like 6 or 7, so don't be too harsh on yourself if you didn't maintain a great GPA. You should be fine for the most part. There is something you <strong>MUST</strong> be careful about though. It can deny you better placements even though you were eligible for it. Slabs. They're used to put you into brackets of salaries.
    </p>
    <figure className="mb-4">
      <img src={img3} alt="CGPU regular" />
      <figcaption className="text-sm text-gray-500">Note: This was the split for my batch. Yours might be different. Confirm with your placement coordinator</figcaption>
    </figure>
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img6} alt="Interview Wojaks" />
      <figcaption className="text-sm text-gray-500">Yeah this is kind of what it is for campus placements</figcaption>
    </figure>
    <h3 className="text-xl font-semibold mt-8 mb-2">The Resume</h3>
    <hr className="mb-4" />
    <p className="mb-4">
    ...
    <ul className="mb-4 list-disc list-inside">
      <li>Education (Since we're freshers)</li>
      <li>Work experience / Internships - especially if its at nice places</li>
      <li>Tools / Technologies - I'd suggest sticking to what you're good at, and what you have used</li>
      ...
      <li>Leadership / Volunteering / Achievements</li>
    ...
    <figure className="mb-4">
      <img src={img7} alt="LightningMcQueenAptitude" />
      <figcaption className="text-sm text-gray-500">Yeah, this happens mostly in your imagination</figcaption>
    </figure>
    <p className="mb-4">
    ...
    <h3 className="text-xl font-semibold mt-8 mb-2">The Coding Round</h3>
    <hr className="mb-4" />
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img8} alt="coding questions car drift" />
      <figcaption className="text-sm text-gray-500">It's the same stuff you do with your answers to evade plagiarism detectors</figcaption>
    </figure>
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img9} alt="Rick rolling" />
      <figcaption className="text-sm text-gray-500">Okay I'm sorry. But am I really?</figcaption>
    </figure>
    <p className="mb-4">
    ...
    <h3 className="text-xl font-semibold mt-8 mb-2">Interviews</h3>
    <hr className="mb-4" />
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img11} alt="breaking bad dangerous" />
      <figcaption className="text-sm text-gray-500">Fastest "I know Java" to "I don't know Java" in existence.</figcaption>
    </figure>
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img12} alt="tyrion advice" />
      <figcaption className="text-sm text-gray-500">Please don't make it end this way. Anything but this.</figcaption>
    </figure>
    <p className="mb-4">
    ...
    <h3 className="text-xl font-semibold mt-8 mb-2">The HR Round</h3>
    <hr className="mb-4" />
    <p className="mb-4">
    ...
    <h3 className="text-xl font-semibold mt-8 mb-2">In summation</h3>
    <hr className="mb-4" />
    <p className="mb-4">
    ...
    <figure className="mb-4">
      <img src={img14} alt="Samwell GoT ending" />
      <figcaption className="text-sm text-gray-500">Of course I had to do the cliche ending. I mean, have you met me?</figcaption>
    </figure>
    <p className="mb-4">
